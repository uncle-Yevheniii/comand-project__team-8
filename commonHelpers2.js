import"./assets/styles-afd6f630.js";import{a as l}from"./assets/vendor-a61d8330.js";async function m(){const o="https://food-boutique.b.goit.study/api/products/popular";return(await l.get(o)).data}document.addEventListener("DOMContentLoaded",v);const i=document.querySelector(".wrapperPopularProduct");async function v(){try{const o=await g();if(o===void 0)throw new Error;h(o)}catch{u()}}async function g(){try{return(await m()).reduce((e,t)=>e+f(t),"")}catch{u()}}function f({img:o,name:e,price:t,size:c,popularity:a}){return`
