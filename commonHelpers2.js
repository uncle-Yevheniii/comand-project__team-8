import{c as n}from"./assets/sptite-764bed88.js";import{a as m,S as T}from"./assets/vendor-3d334923.js";async function A(){const t="https://food-boutique.b.goit.study/api/products/categories";try{return(await m.get(t)).data}catch(e){return console.error("Помилка під час запиту:",e),[]}}async function j({keyword:t,category:e,page:o,limit:c}){const r="https://food-boutique.b.goit.study/api/products";return(await m.get(r,{params:{keyword:t,category:e,page:o,limit:c}})).data}async function H(){const t="https://food-boutique.b.goit.study/api/products/popular";return(await m.get(t)).data}async function z(){const t="https://food-boutique.b.goit.study/api/products/discount";return(await m.get(t)).data}const u=document.querySelector(".wrapperPopularProduct");console.log(u);const b=document.querySelector("body");u.addEventListener("click",y);const p=document.querySelector(".products-list");console.log(p);p.addEventListener("click",h);async function h(t){p.removeEventListener("click",h);const e=t.target.closest(".productlist-card");if(e===null||t.target.closest(".productlist-card-btn")){p.addEventListener("click",h);return}console.log(e);const o=e.dataset.id,c=await S(o);console.log(c),b.insertAdjacentHTML("beforeend",$(c));const r=document.querySelector(".modal-wimdow-add-to-cart-btn");(JSON.parse(localStorage.getItem("cart"))||[]).find(d=>d._id===c._id)&&(r.style.background="#6d8434",r.textContent="Added to"),I()}async function y(t){u.removeEventListener("click",y);const e=t.target.closest("li");if(e===null||t.target.closest(".popular__products-button")){u.addEventListener("click",y);return}const o=e.dataset.id,c=await S(o);console.log(c),b.insertAdjacentHTML("beforeend",$(c));const r=document.querySelector(".modal-wimdow-add-to-cart-btn");(JSON.parse(localStorage.getItem("cart"))||[]).find(d=>d._id===c._id)&&(r.style.background="#6d8434",r.textContent="Added to"),I()}async function S(t){const e="https://food-boutique.b.goit.study/api/products/";return m.get(`${e}${t}`).then(o=>o.data).catch(o=>{throw new Error(o)})}function $(t){let e;const{_id:o,name:c,category:r,size:s,popularity:a,desc:d,price:f,img:k}=t;return r.includes("_")&&(e=r.split("_").join(" ")),`
  ...
  `}).join("")}window.addEventListener("load",_);l.addEventListener("click",U);async function U(t){const o=t.target.closest(".productlist-card-btn");if(o){const r=o.closest(".productlist-card").dataset.id,s=await S(r);s.quantity=1,Q(s,o)}}function Q(t,e){let o=JSON.parse(localStorage.getItem("cart"))||[];if(o.find(r=>r._id===t._id)){const r=e.querySelector(".productlist-card-icon-cart use"),s=e.querySelector(".productlist-card-icon-cart");console.log(s),s.classList.replace("productlist-card-icon-cart","productlist-card-icon-check"),r.setAttribute("href",`${n}#icon-check`),e.setAttribute("disabled","disabled")}else o.push(t),localStorage.setItem("cart",JSON.stringify(o)),console.log("Товар доданий в кошик!");_()}function _(){const t=JSON.parse(localStorage.getItem("cart"))||[],e=document.querySelector(".js-header-span");e&&(e.textContent=t.length)}const X=document.querySelector(".filters-form"),v=document.querySelector(".filters-form-input"),g=document.querySelector(".filters-form-select-category"),Y=t=>t.map(e=>`<option value="${e.trim()}">${e.replace("_"," ").replace("_"," ")}</option>`).join("");let L=[];const Z=async()=>{L=[...await A()];const e=Y(L);g.insertAdjacentHTML("beforeend",e),new T({select:"#category",settings:{showSearch:!1}})};Z();const tt=t=>{t.preventDefault();const e=v.value.trim(),o=g.value,c={keyword:e||null,category:o==="Show all"?null:o.trim()||null};localStorage.setItem("settings",JSON.stringify(c)),i()},et=t=>{if(t.target.value===""){const e=g.value,o={keyword:null,category:e==="Show all"?null:e.trim()||null};localStorage.setItem("settings",JSON.stringify(o)),i()}},ot=t=>{const e=v.value.trim(),o=t.target.value,c={keyword:e||null,category:o.trim()||null};localStorage.setItem("settings",JSON.stringify(c)),i()};window.addEventListener("load",()=>{const t=JSON.parse(localStorage.getItem("settings"))||{keyword:null,category:null};v.value=t.keyword,g.value=t.category,i(),X.addEventListener("submit",tt),g.addEventListener("change",ot),v.addEventListener("input",et)});const ct={keyword:null,category:null,page:1,limit:6},rt=[];function q(){if(!localStorage.getItem("settings"))return localStorage.setItem("settings",JSON.stringify(ct))}function E(){if(!localStorage.getItem("cart"))return localStorage.setItem("cart",JSON.stringify(rt))}const P=document.querySelector(".card-discount-prod");q();E();function st(t){return t.map(({img:e,name:o,price:c,_id:r})=>`<li class="discount-prod-item slide" data-id='${r}'>
...
</li>`).join("")}function at(){z().then(t=>{nt(t),P.insertAdjacentHTML("beforeend",st(t))}).catch(t=>console.log(t.message))}at();function nt(t){let e=Math.floor(Math.random()*t.length),o=Math.floor(Math.random()*t.length);if(e===o)return;let c=t[o];t[o]=t[e],t[e]=c}window.addEventListener("load",O);P.addEventListener("click",dt);function dt(t){const o=t.target.closest(".btn-icon-cart");if(o){const c=o.closest(".discount-prod-item"),s={id:c.dataset.id,name:c.querySelector(".text-discount-prod").textContent,price:c.querySelector(".price-text-disc").textContent,category:c.dataset.category,img:c.querySelector(".discount-img").src,size:c.dataset.size};it(s,o)}}function it(t,e){let o=JSON.parse(localStorage.getItem("cart"))||[];if(o.find(r=>r.id===t.id)){const r=e.querySelector(".icon-cart-svg use");r.setAttribute("style","stroke: var(--background); fill: var(--p_color);"),r.setAttribute("href",`${n}#icon-check`)}else o.push(t),localStorage.setItem("cart",JSON.stringify(o));O()}function O(){const t=JSON.parse(localStorage.getItem("cart"))||[],e=document.querySelector(".js-header-span");e&&(e.textContent=t.length)}const J=document.querySelector(".wrapperPopularProduct");document.querySelector("body");document.addEventListener("DOMContentLoaded",lt);async function lt(){try{const t=await pt();if(t===void 0)throw new Error;gt(t)}catch{N()}}function ut({category:t,img:e,name:o,popularity:c,size:r,_id:s}){return`
