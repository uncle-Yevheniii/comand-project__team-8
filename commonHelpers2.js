import{a as G,c as i,f as U,b as Q,d as X,e as Z}from"./assets/API-5236cc24.js";import{a as tt,P as et,S as st}from"./assets/vendor-c8bc0669.js";document.querySelector(".wrapperPopularProduct");document.querySelector("body");const N=document.querySelector(".wrapperPopularProduct");document.querySelector(".popular__products-button");document.addEventListener("DOMContentLoaded",ot);async function ot(){try{const t=await L();if(t===void 0)throw new Error;$(t)}catch{W()}}function at(t){return t.map(({name:e,img:s,category:o,size:a,popularity:c,price:r,is10PercentOff:n,_id:u})=>{o.includes("_")&&(o=o.split("_").join(" "));const p=(JSON.parse(localStorage.getItem("cart"))||[]).find(P=>P._id===u);return`
  ...
  <div class="modal-container modal-product" data-id="${s}" data-modal">
    ...
    `}function M(){const t=document.querySelector("[data-modal-close]"),e=document.querySelector(".backdrop");document.querySelector("[data-modal]").addEventListener("click",it);function o(){const r=document.querySelector("[data-modal]");r&&(r.remove(),t.removeEventListener("click",o),document.removeEventListener("keydown",c),e.removeEventListener("click",a))}function a(r){r.target===e&&(o(),e.removeEventListener("click",a))}function c(r){r.code==="Escape"&&(o(),document.removeEventListener("keydown",c))}g.addEventListener("click",l),v.addEventListener("click",h),f.addEventListener("click",I),t.addEventListener("click",o),e.addEventListener("click",a),document.addEventListener("keydown",c),document.querySelector("[data-modal]")||E.insertAdjacentHTML("beforeend",_(info))}async function it(t){const s=t.target.closest(".modal-wimdow-add-to-cart-btn");if(s){const a=s.closest(".modal-container").dataset.id,c=await m(a);c.quantity=1,dt(c,s);const r=await L();$(r),d()}}function dt(t,e){let s=JSON.parse(localStorage.getItem("cart"))||[];s.find(a=>a._id===t._id)?(e.style.background="#6d8434",e.textContent="Remove from"):(s.push(t),localStorage.setItem("cart",JSON.stringify(s)),e.style.background="#6d8434",e.childNodes[0].nodeValue="Remove from"),lt()}function lt(){const t=JSON.parse(localStorage.getItem("cart"))||[],e=document.querySelector(".js-header-span");e&&(e.textContent=t.length)}const ut=document.getElementById("pagination");let q=0;const pt=window.innerWidth;pt<768?q=2:q=4;function mt(t,e,s){const o={totalItems:t.totalPages*e,itemsPerPage:e,visiblePages:q,page:s,centerAlign:!1,template:{page:'<a href="#" class="tui-page-btn">{{page}}</a>',currentPage:'<strong class="tui-page-btn tui-is-selected">{{page}}</strong>',moveButton:'<a href="#" class="tui-page-btn tui-{{type}}"><span class="tui-ico-{{type}}">{{type}}</span></a>',disabledMoveButton:'<span class="tui-page-btn tui-is-disabled tui-{{type}}"><span class="tui-ico-{{type}}">{{type}}</span></span>',moreButton:'<a href="#" class="tui-page-btn tui-is-disabled tui-{{type}}-is-ellip"><span class="tui-ico-ellip">...</span></a>'}};new et(ut,o).on("afterMove",c=>{const r=c.page,n=JSON.parse(localStorage.getItem("settings"))||{};n.page=r,localStorage.setItem("settings",JSON.stringify(n)),d()})}const b=document.querySelector(".products-list"),J=document.querySelector(".products-list-none"),y=document.querySelector(".pagination-block"),gt={keyword:null,category:null,page:1,limit:6};window.addEventListener("resize",vt);function ft(t){return window.innerWidth<768?t.limit=6:window.innerWidth>=768&&window.innerWidth<1440?t.limit=8:t.limit=9,t}async function d(){return localStorage.getItem("settings")?await T(JSON.parse(localStorage.getItem("settings"))):await T(gt)}async function T(t){try{t=ft(t);const e=JSON.parse(localStorage.getItem("settings"));e.limit=t.limit,localStorage.setItem("settings",JSON.stringify(e));const s=await U(t);s.results.length===0?(J.classList.remove("hidden"),b.classList.add("hidden"),y.classList.add("hidden")):(b.classList.contains("hidden")&&(J.classList.add("hidden"),b.classList.remove("hidden"),y.classList.remove("hidden")),b.innerHTML=ht(s.results),s.totalPages>1?(y.classList.contains("hidden")&&y.classList.remove("hidden"),mt(s,s.perPage,s.page)):y.classList.add("hidden"))}catch(e){console.log(e.message)}}function vt(){const t=JSON.parse(localStorage.getItem("settings"));window.innerWidth<768&&t.limit===6||window.innerWidth>=768&&window.innerWidth<1440&&t.limit===8||window.innerWidth>=1440&&t.limit===9||d()}function ht(t){return t.map(({name:e,img:s,category:o,size:a,popularity:c,price:r,is10PercentOff:n,_id:u})=>{o.includes("_")&&(o=o.split("_").join(" "));const p=(JSON.parse(localStorage.getItem("cart"))||[]).find(P=>P._id===u);return`
  ...
  `}).join("")}window.addEventListener("load",D);b.addEventListener("click",yt);async function yt(t){const s=t.target.closest(".productlist-card-btn");if(s){const a=s.closest(".productlist-card").dataset.id,c=await m(a);c.quantity=1,St(c,s),d();const r=await L();$(r)}}function St(t,e){let s=JSON.parse(localStorage.getItem("cart"))||[];if(s.find(a=>a._id===t._id)){const a=e.querySelector(".productlist-card-icon-cart use");e.querySelector(".productlist-card-icon-cart").classList.replace("productlist-card-icon-cart","productlist-card-icon-check"),a.setAttribute("href",`${i}#icon-check`),e.setAttribute("disabled","disabled")}else s.push(t),localStorage.setItem("cart",JSON.stringify(s));D()}function D(){const t=JSON.parse(localStorage.getItem("cart"))||[],e=document.querySelector(".js-header-span");e&&(e.textContent=t.length)}const bt=document.querySelector(".filters-form"),k=document.querySelector(".filters-form-input"),w=document.querySelector(".filters-form-select-category"),wt=t=>t.map(e=>`<option value="${e.trim()}">${e.replace("_"," ").replace("_"," ")}</option>`).join("");let j=[];const kt=async()=>{j=[...await Q(),"Show all"];const e=wt(j);w.insertAdjacentHTML("beforeend",e);const s=JSON.parse(localStorage.getItem("settings"))||{keyword:null,category:null};w.value=s.category,new st({select:"#category",settings:{showSearch:!1}})};kt();const Lt=t=>{t.preventDefault();let e=JSON.parse(localStorage.getItem("settings"))||{keyword:null,category:null};const s=k.value.trim(),o=w.value;e.keyword=s||null,e.category=o==="Show all"?null:o.trim()||null,localStorage.setItem("settings",JSON.stringify(e)),d()},$t=t=>{if(t.target.value===""){let e=JSON.parse(localStorage.getItem("settings"))||{keyword:null,category:null};const s=w.value;e.keyword=null,e.category=s==="Show all"?null:s.trim()||null,localStorage.setItem("settings",JSON.stringify(e)),d()}},Et=t=>{let e=JSON.parse(localStorage.getItem("settings"))||{keyword:null,category:null};const s=k.value.trim(),o=t.target.value;e.keyword=s||null,e.category=o==="Show all"?null:o.trim()||null,e.page=1,localStorage.setItem("settings",JSON.stringify(e)),d()};window.addEventListener("load",()=>{const t=JSON.parse(localStorage.getItem("settings"))||{keyword:null,category:null};k.value=t.keyword,d(),bt.addEventListener("submit",Lt),k.addEventListener("input",$t),w.addEventListener("change",Et)});const It={keyword:null,category:null,page:1,limit:6},_t=[];function R(){if(!localStorage.getItem("settings"))return localStorage.setItem("settings",JSON.stringify(It))}function V(){if(!localStorage.getItem("cart"))return localStorage.setItem("cart",JSON.stringify(_t))}const z=document.querySelector(".card-discount-prod");R();V();function Ct(t){return t.map(({img:e,name:s,price:o,_id:a})=>{const r=(JSON.parse(localStorage.getItem("cart"))||[]).find(n=>n._id===a);return`<li class="discount-prod-item slide" data-id='${a}'>
